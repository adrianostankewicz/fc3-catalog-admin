...
public class CategoryTest {
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final var expectedName = """
                    O empenho em analisar o comprometimento entre as equipes aponta para a melhoria do retorno esperado 
                    a longo prazo. Por outro lado, a complexidade dos estudos efetuados representa uma abertura para a 
